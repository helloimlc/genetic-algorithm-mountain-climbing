...
class Population:
    def __init__(self, pop_size, gene_count, symmetric=False, cylinder_only = True):
        self.creatures = [
            creature.Creature(gene_count=gene_count, id=id,  symmetric=symmetric, cylinder_only=cylinder_only)
